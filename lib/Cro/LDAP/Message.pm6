...
class ProtocolChoice does ASNChoice {
    method ASN-choice {
        ...
        modDNRequest => Cro::LDAP::Request::ModifyDN,
        modDNResponse => Cro::LDAP::Response::ModifyDN,
        compareRequest => Cro::LDAP::Request::Compare,
        compareResponse => Cro::LDAP::Response::Compare,
